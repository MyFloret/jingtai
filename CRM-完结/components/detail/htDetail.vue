<template>
	<view>
		...
		<view class="flex-white-plr26 ptb20 bdb_f5">
			<text class="mr26">关联商机</text>
			<view class="width276 blueColor flexC" v-if="infoObj.sjId" @click="navigateToFun('sj')">
				<text>{{infoObj.sjName}}</text>
			</view>
			<view v-else class="width276">暂无</view>
		</view>
		<view class="flex-white-plr26 ptb20 bdb_f5">
			<text class="mr26">报价单</text>
			<view class="width276 blueColor flexC" v-if="infoObj.bjdId" @click="navigateToFun('bjd')">
