	...
	<view class="detil_shop" v-else>
		...
		<view class="introduce">
			...
			<view class="text_title" :class="{'text_t':showInfo==true}">
				...
				<view class="introduceCompay_name marginTop">
					<p>公司简介</p>
					<p class="_play">{{contentDetail.companyDesc}}
					</p>
				</view>
			</view>
...
<!-- 		<view class="onlineTile">
		...
		<view class="bottomPo">
			<view class="bottomPoLeft">
				...
				<view class="flBox box" @click="blockFl(2)"> <!-- @click="activeTab = 2" -->
			...
			<!-- 	<button open-type="im" :data-im-id="89753866770" @im="imCallback" @error="onimError" class="online btnCl">
					在线沟通
				</button> -->
			</view>
		</view>
