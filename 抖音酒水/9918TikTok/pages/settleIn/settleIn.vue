	...
	export default {
		...
		methods: {
			...
			onProvinceChange(province) {
				...
				this.provinceIndex = this.provinceList.findIndex(item => item.Name === province.Name)
				this.cityListlengthType = -1
				this.citylengthType = -1
				console.log(province.ID, 'province');
				this.provinceID = province.ID
				requestUrl('/Sites/GetWineType', 'GET', {
			...
			selectOptionVillage(provinceAll) {
				...
				console.log(this.cityCardNavLenght[this.countryIndexTab].areaList[this
					.countryIndexTabVillage], '乡');
