...
<script>
	...
	import { qywxTyDropDown, qywxDropDownByUser, qwkhsxData, datePxData } from '@/static/utils/dropdown.js'
	import {
	...
	export default {
		...
		onLoad(e) {
			that = this;
			let khsxList = JSON.stringify(qwkhsxData);
