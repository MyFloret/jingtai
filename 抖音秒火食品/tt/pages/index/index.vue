						...
						<view class="shop_listDetial" v-for="(item, index) in shopList" :key="index">
							...
							<view class="swiper_conDetial">
								<view class="swiper_imgDetial">
									<view class="imgSwiperDetial" v-for="(i, ins) in produceByUserId" :key="ins"
										v-if="item.userId==i.userId" @click="ShopDetailClick(i)">
										<img :src="i.procPic" alt="">
									</view>
			...
			<view v-show="currentIndex === 2">
				...
				<view class="_t">
					<view class="tab-bar_t">
						<view class="tab_t" :class="{active_t: activeTab === 23}" @click="GetProductListClick(23)">食品
						</view>
						<view class="tab_t" :class="{active_t: activeTab === 22}" @click="GetProductListClick(22)">饮料
						</view>
						<view class="tab_t" :class="{active_t: activeTab === 21}" @click="GetProductListClick(21)">酒水
						</view>
						<view class="tab_t" :class="{active_t: activeTab === 32}" @click="GetProductListClick(32)">调味料
						</view>
					</view>
		...
		methods: {
			...
			GetHotCompanyList() {
				request('/Home/GetHotCompanyList', 'GET').then((res) => {
					...
					this.produceByUserId = res.data.produceByUserId
