<template>
	<view class="_t">
		...
		<view class="uni_swipers">
			<image v-if="id == 1139" src="/static/img/qiujibanner.png" mode="widthFix"></image>
			<image v-if="id != 1139" :src="img_src" mode="widthFix"></image>
			<view class="search_ex" v-if="id == 1139" >
		...
		<view class="exhibition" v-if="id != 1139">
		...
		<view v-if="id == 1139" v-for="(item, index) in shopQyClick"
		...
		<!-- 线路图 -->
		<view class="program" @click="goprgram" v-if="teid==1139">
