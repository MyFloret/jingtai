<template>
	<view class="_t">
		<view class="tab-bar_t">
			...
			<view class="tab_t" @click="clickFood(21201)">白酒</view>
			<view class="tab_t" @click="clickFood(20288)">啤酒</view>
			<view class="tab_t" @click="clickFood(20289)">葡萄酒</view>
			<view class="tab_t" @click="clickFood('all')">其它酒</view>
		</view>
		<view class="uni_swipers">
			<image v-if="id == 839" src="/static/img/yiyiling.jpg" mode="widthFix"></image>
			<image v-if="id != 839" :src="img_src" mode="widthFix"></image>
			<view class="search_ex" v-if="id == 839" >
		...
		<view class="exhibition" v-if="id != 839">
		...
		<view v-if="id == 839" v-for="(item, index) in shopQyClick"
		...
		<!-- 线路图 -->
		<view class="program" @click="goprgram" v-if="teid==839">
