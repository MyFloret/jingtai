				...
				<view v-else>
					...
					<view class="diamond1">
						...
						<view class="diamondKey">
							<!-- 点击跳转到美食专页 -->
							<view class="key Food" @click="clickFood(1)">
								<img src="../../static/img/dgao.png" alt="食品">
								<view class="food">
									食品
								</view>
							</view>
							<!-- 点击跳转到饮料专页 -->
							<view class="key Yl" @click="clickFood(2)">
								<img src="../../static/img/s_g.png" alt="饮料">
								<view class="yl">
									饮料
								</view>
							</view>
							<!-- 点击跳转到酒水专页 -->
							<view class="key Js" @click="clickFood(3)">
								<img src="../../static/img/h_j.png" alt="酒水">
								<view class="juis">
									酒水
								</view>
							</view>
							<!-- 点击跳转到调料品专页 -->
							<view class="key Tlp" @click="clickFood(4)">
								<img src="../../static/img/t_w.png" alt="调味品">
								<view class="tlp">
									调料品
								</view>
							</view>
