	...
	<view class="login">
		...
		<view class="inputName">
			...
			<view class="form-group">
				...
				<input type="text" v-model="name" class="input" placeholder="请输入您的姓名（选填）" required />
			</view>
			<view class="form-group">
				<view class="label">
					<img src="../../static/img/gs_copy.png" alt="">
				</view>
				<input type="text" v-model="gsName" class="input" placeholder="请输入您的公司名称（选填）" required />
			</view>
			<view class="sub_btn">
			...
			<view class="penBook">
				...
				<view class="radio">
					...
					<view class="checkout">
						提交即同意<span @click='tabClick'>《食品好帮手服务协议》</span>
					</view>
				</view>
			</view>
		</view>
