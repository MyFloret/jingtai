<template>
	<view class="boxContent">
		...
		<view v-if="!isLoading">
			<canvas v-if="canvasShow" canvas-id="canvasFunnel" id="canvasFunnel" class="charts" @touchstart="touchFunnel"></canvas>
		...
		methods: {
			getServerData() {
				...
				.then(res => {
					...
					that.showFunnel("canvasFunnel", funnelData);
				})
			},
