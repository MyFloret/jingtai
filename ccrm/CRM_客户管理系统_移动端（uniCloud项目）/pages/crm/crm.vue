	...
	export default {
		...
		methods: {
			setMenuList: function() {
					...
					list = [
						{
							name: '客户管理',
							arr: [
								{ name: '线索池', img: '../../static/crm/threadChi.png', url: './thread/threadc', menu_id: 'threadC' },
								{ name: '线索', img: '../../static/crm/thread.png', url: './thread/thread', menu_id: 'thread' },
								{ name: '客户池', img: '../../static/crm/gonghaichi.png', url: './kehu/kehuGh', menu_id: 'clientGh' },
								{ name: '客户', img: '../../static/crm/kehu1.png', url: './kehu/kehu', menu_id: 'client' },
								{ name: '联系人', img: '../../static/crm/lianxiren.png', url: './lianxiren/lianxiren', menu_id: 'linkman' },
								{ name: '企微客户', img: '../../static/crm/qywxLogo.png', url: '../../qywxPage/view/qywxClient/qywxClient', menu_id: 'qywxClient' },
								{ name: '跟进记录', img: '../../static/crm/genjin.png', url: './genJin/genJin', menu_id: 'followUp' },
								{ name: '企微跟进', img: '../../static/crm/genjin.png', url: './genJin/genJin?isQywx=true', menu_id: 'followUpQywx' },
							]
						},
						{
							name: '销售管理',
							arr: [
								{ name: '商机', img: '../../static/crm/shangji.png', url: './shangji/shangji', menu_id: 'business' },
								{ name: '企微商机', img: '../../static/crm/shangji.png', url: './shangji/shangji?isQywx=true', menu_id: 'businessQywx' },
								{ name: '报价单', img: '../../static/crm/baojiadan.png', url: './baoJiaDan/baoJiaDan', menu_id: 'quotation' },
								{ name: '企微报价单', img: '../../static/crm/baojiadan.png', url: './baoJiaDan/baoJiaDan?isQywx=true', menu_id: 'quotationQywx' },
								{ name: '合同', img: '../../static/crm/hetong.png', url: './hetong/hetong', menu_id: 'contract' },
								{ name: '企微合同', img: '../../static/crm/hetong.png', url: './hetong/hetong?isQywx=true', menu_id: 'contractQywx' },
							]
						},
						{
							name: '财务管理',
							arr: [
								{ name: '回款计划', img: '../../static/crm/hkjh.png', url: './huikuanJH/huikuanJH', menu_id: 'hkjh' },
								{ name: '企微计划', img: '../../static/crm/hkjh.png', url: './huikuanJH/huikuanJH?isQywx=true', menu_id: 'hkjhQywx' },
								{ name: '实际回款', img: '../../static/crm/huikuan.png', url: './huikuan/huikuan', menu_id: 'sjhk' },
								{ name: '企微回款单', img: '../../static/crm/huikuan.png', url: './huikuan/huikuan?isQywx=true', menu_id: 'sjhkQywx' },
							]
						},
						{
							name: '产品管理',
							arr: [
								{ name: '商城预览', img: '../../static/crm/shopIcon.png', url: '../../chanpin/view/shop' },
								{ name: '产品管理', img: '../../static/crm/chanpin.png', url: '../../chanpin/view/chanpin', menu_id: 'pList' },
								{ name: '产品分类', img: '../../static/crm/cpfl.png', url: '../../chanpin/view/classify', menu_id: 'pClassify' }
							]
						},
					]
				} else {
				...
				let role = uni.$userInfo.role;
				console.log(role)
				if(role.length > 0 && role[0] == 'admin') {
					this.list = list;
				} else {
					let arr = [];
