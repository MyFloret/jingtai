...
function LoadSite(divId, lng, lat, infoWindow, CompanName, SizeCent, address) {
    ...
    if (lng.length < 3 || lat.length < 3) {
        ...
        var markerIcon = new BMap.Icon("/images/usAddress.png", new BMap.Size(23, 25));
        ...
        var label = new BMap.Label(CompanName, { offset: new BMap.Size(-43, -47) });
