		...
		methods: {
			...
			getSalesJianBaoFun: function() {
				...
				this.$http.get(`Dealer/GetDealerInfoPageList`, {
					...
					if (res.Data) {
						let list = this.salesJbList
						list[0].value = res.Data.length
						this.salesJbList = list
				...
				// 		list[0].value = obj.client;
				// 		// list[1].value = obj.business;
				// 		// list[2].value = obj.quotation;
				// 		// list[3].value = obj.contract;
				// 		// list[4].value = obj.hkjh;
				// 		// list[5].value = obj.hkd;
